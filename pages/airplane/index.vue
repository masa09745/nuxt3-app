...
<template>
  <div class="shadow-lg rounded-2xl w-64 p-4 py-6 bg-white">
      <div class="flex flex-col items-center justify-center">
          <div class="w-24 h-24 bg-green-200 rounded-full relative">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 2304 1792" class="w-8 h-8 text-green-700 absolute left-1/2 top-1/2 transform -translate-y-1/2 -translate-x-1/2" xmlns="http://www.w3.org/2000/svg">
